...
---
Sometime between version 1.5 and 1.7.10 of Minecraft, the source code has undergone significant refactoring and made use of previously unused Java features, in particular, [Nested](http://docs.oracle.com/javase/tutorial/java/javaOO/nested.html) and [Anonymous](http://docs.oracle.com/javase/tutorial/java/javaOO/anonymousclasses.html) classes, making my transpiler no longer "good enough" and thus needing to be improved.
